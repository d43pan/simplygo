...
class Database {
    ...
    public function __construct() {
        ...
        $this->db->exec('CREATE TABLE IF NOT EXISTS redirects (id INTEGER PRIMARY KEY, path TEXT UNIQUE, url TEXT, deleted INTEGER DEFAULT 0, created DATETIME DEFAULT CURRENT_TIMESTAMP)');
    }
